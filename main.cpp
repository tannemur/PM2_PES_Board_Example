...
int main()
{
    ...
    //DigitalIn mechanical_button(PC_1);     // set pullup mode: sets pullup between pin and 3.3 V, so that there is a defined potential
